...
# 129 "main.c"
    ADCC_StartConversion(0x01);

    while (1)
    {
        DIPValues = (PORTAbits.RA0 << 1) | PORTAbits.RA1;
        ...
        if(OutputSelect == 3){
            ...
            while(DIPValues == OutputSelect){
                DIPValues = PORTAbits.RA0 + PORTAbits.RA1;
                ...
                for(uint16_t i = 0; i < 100; i++){
                    ...
                    SPI1_WriteByte(OutDataUpper);
                    SPI1_WriteByte(OutDataLower);
